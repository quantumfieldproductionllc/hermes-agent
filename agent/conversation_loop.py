...
def run_conversation(
    ...
    _eme_prefetch_cache = getattr(_ctx, "eme_prefetch_cache", "")
                ...
                if finish_reason == "length":
                    ...
                    if agent.api_mode in {"chat_completions", "bedrock_converse", "anthropic_messages"}:
                        ...
                        if assistant_message is not None and not _trunc_has_tool_calls:
                            ...
                            partial_response = agent._strip_think_blocks(sanitize_context(_join_truncated_parts(truncated_response_parts))).strip()
                            if partial_response:
                                agent._vprint(

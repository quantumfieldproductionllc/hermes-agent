...
TOOLSETS = {
    ...
    "moa": {
        "description": "Mixture of Agents virtual provider and /moa command support",
        "tools": [],
        "includes": []
    },
    ...
    "hermes-telegram-userbot": {
        "description": "Telegram userbot participant toolset - restricted external access, no local/admin tools",
        "tools": [
            "web_search",
            "web_extract",
            "vision_analyze",
